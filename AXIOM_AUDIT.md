...
- **2 remaining GaussianFin** axioms (merged to main 2026-05-13, commit
  `8ed9e52`) — multivariate Gaussian BE-instance primitives, both
  gemini-3.1-pro-preview vetted **Standard**, both tensor-lift analogues
  of historical 1D primitives that were already discharged in
  `Gaussian1D`:
